...
// function AdminAllAccepted(props) {
//   const [requests, setRequests] = useState([]);
//   const[refreshing,setRefreshing] =useState(true);

//   function cancelRequest(input){
//   Axios.post('http://10.0.2.2:8000/cancelApprovedRequestsA',{  
//     _id:input
//   },{
...
//     Axios.get('http://10.0.2.2:8000/ApprovedRequests',{
//       headers:{authorization:'Bearer ' +props.token},
//     }
//     ).then((response)=>{
...
//     )
// }
// export default AdminAllAccepted;
...
function AdminAllAccepted({navigation}) {
  const [requests, setRequests] = useState([]);
  const[refreshing,setRefreshing] =useState(true);
